    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <img class="img-fluid mt-5" src="<?php echo e(asset('global')); ?>/img/girl.svg" alt="" />
            </div>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row pb-3">
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="<?php echo e(asset('global')); ?>/img/img5.jpg" alt="" />
                        <div class="card-body bg-third text-center p-4">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary px-4 mx-auto my-2">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="<?php echo e(asset('global')); ?>/img/img6.jpg" alt="" />
                        <div class="card-body bg-third text-center p-4">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="<?php echo e(asset('global')); ?>/img/img7.jpg" alt="" />
                        <div class="card-body bg-third text-center p-4">
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\laratod\hitoefl\resources\views/site/home/index.blade.php ENDPATH**/ ?>