    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-5 mb-lg-0" src="<?php echo e(asset('global')); ?>/img/Office.jpeg" alt="" />
                </div>
                <div class="col-lg-7">
                    ...
                    <p>HiTOEFL is a company founded in 2022. We are here to help people's preaparation for their TOEFL Test
                        ...
                        world.</p>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary mt-2 py-2 px-4">Learn More</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\dev\laratod\hitoefl\resources\views/site/about/index.blade.php ENDPATH**/ ?>