...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('global/dasbor/static')); ?>/img/icons/icon-48x48.png">

    <link rel="canonical" href="https://demo-basic.adminkit.io/">

    <title>HiTOEFL - Dashboard</title>

    <link href="<?php echo e(asset('global/dasbor/static')); ?>/css/app.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('global/feathericon-release')); ?>/css/feathericon.min.css">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="index.html">
                            <i class="align-middle" data-feather="book"></i> <span class="align-middle">My Class</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo e(route('dashboard.bookclass.index')); ?>">
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <img src="<?php echo e(asset('global')); ?>/img/7uno.png" class="avatar img-fluid rounded me-3"
...
<?php endif; ?>
            ...
            <main class="content">
                ...
                <table border="1">
                    ...
                    <?php $__currentLoopData = $bookclass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($b->topic); ?></td>
                            <td><?php echo e($b->teachers); ?></td>
                        ...
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://adminkit.io/"
                                    target="_blank"><strong>HiTOEFL</strong></a> &copy;
                            </p>
                        </div>
    ...
    <script src=<?php echo e(asset('global/dasbor/static/js/app.js')); ?>></script>
...
<?php /**PATH C:\dev\laratod\hitoefl\resources\views/index.blade.php ENDPATH**/ ?>