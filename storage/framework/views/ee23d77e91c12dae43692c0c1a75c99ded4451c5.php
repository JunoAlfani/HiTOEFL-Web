...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-sky-900 shadow-sm focus:ring-sky-700" name="remember">
...
<?php endif; ?>
<?php /**PATH C:\dev\laratod\hitoefl\resources\views/auth/login.blade.php ENDPATH**/ ?>